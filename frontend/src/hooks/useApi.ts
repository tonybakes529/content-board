...
export const useApi = () => {
  ...
  const updateBoard = useCallback(async (id: number, name: string) => {
    setLoading(true);
    setError(null);
    try {
  ...
  // Cards
  const getCards = useCallback(async (boardId?: number) => {
    setLoading(true);
    setError(null);
    try {
  ...
  const updateCard = useCallback(async (id: number, cardData: any) => {
    setLoading(true);
    setError(null);
    try {
  ...
  const duplicateCard = useCallback(async (id: number) => {
    setLoading(true);
    setError(null);
    try {
  ...
  const getYoutubeTranscript = useCallback(async (url: string) => {
    setLoading(true);
    setError(null);
    try {
